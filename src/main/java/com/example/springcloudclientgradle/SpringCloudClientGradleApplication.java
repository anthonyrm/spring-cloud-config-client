package com.example.springcloudclientgradle;
...
@RestController
@RefreshScope
public class SpringCloudClientGradleApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(SpringCloudClientGradleApplication.class, args);
    }
